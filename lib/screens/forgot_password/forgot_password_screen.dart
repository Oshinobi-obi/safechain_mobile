      ...
      builder: (context) {
        return Dialog(
          ...
          child: ClipRRect(
            ...
            child: SliderCaptcha(
              image: Image.asset('images/logo.png', height: 150, fit: BoxFit.contain),
    ...
    try {
      ...
      if (response.statusCode == 200) {
        await showDialog(
          ...
          builder: (_) => SuccessModal(title: 'Request Sent', message: message),
        );
        if (mounted) Navigator.of(context).pop();
      } else {
        showDialog(
          context: context,
          builder: (_) => ErrorModal(title: 'Request Failed', message: message),
        );
      }
    } catch (e) {
      if (mounted) {
